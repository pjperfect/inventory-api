...
def add_item():
    ...
    if missing:
        return make_response(jsonify({"error": f"Missing required fields: {', '.join(missing)}"}), 422)
...
def update_item(item_id):
    ...
    updatable_fields = ["product_name", "brands", "ingredients_text", "quantity", "categories", "price", "stock"]
